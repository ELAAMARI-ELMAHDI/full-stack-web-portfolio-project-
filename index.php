    ...
    <div class="pd-y" id="login">
      <div class="container">
          <div class="intro">
            ...
            <div id="login" name =" login" class="reservation">
              ...
              <form class="form" action="insertLog.php" method="post"  enctype="multipart/form-data">
                  ...
                  <input  class="input" type="text" id="email" name="name" placeholder="Enter your " required >
                  ...
                  <input  class="input"type="password" id="psw" name="psw" placeholder="password"  required >

                  
                  <label class="label" for="">Confirme Password</label>
                  <input  class="input"type="password" id="psw" name="cpsw" placeholder="confirme password"  required >
